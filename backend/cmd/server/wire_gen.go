...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	affiliateIdentityRepository := repository.NewAffiliateIdentityRepository(client, db)
	affiliateService := service.ProvideAffiliateService(affiliateRepository, affiliateIdentityRepository, settingService, apiKeyAuthCacheInvalidator, billingCacheService)
	smsCache := service.ProvideSMSCache(emailCache)
	smsService := service.ProvideSMSService(settingRepository, smsCache)
	authService := service.ProvideAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, subscriptionService, affiliateService, smsService, serviceUserPlatformQuotaRepository)
	...
	authHandler := handler.ProvideAuthHandler(configConfig, authService, userService, settingService, promoService, redeemService, totpService, smsService, userAttributeService, paymentService)
	affiliateWithdrawalRepository := repository.NewAffiliateWithdrawalRepository(client, db)
	affiliateWithdrawalService := service.NewAffiliateWithdrawalService(affiliateWithdrawalRepository, settingService)
	userHandler := handler.NewUserHandler(userService, authService, emailService, emailCache, affiliateService, affiliateWithdrawalService, paymentService, serviceUserPlatformQuotaRepository)
	apiKeyHandler := handler.NewAPIKeyHandler(apiKeyService)
	usageLogRepository := repository.NewUsageLogRepository(client, db)
	usageService := service.NewUsageService(usageLogRepository, userRepository, client, apiKeyAuthCacheInvalidator)
	usageHandler := handler.ProvideUsageHandler(usageService, apiKeyService, settingService)
	...
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, paymentService, serviceUserPlatformQuotaRepository)
	accountRuntimeBlocker := service.ProvideAccountRuntimeBlocker(openAIGatewayService)
	adminService := service.NewAdminService(userRepository, groupRepository, accountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, accountRuntimeBlocker)
	...
	smsBroadcastRepository := repository.NewSMSBroadcastRepository(client, db)
	smsBroadcastService := service.ProvideSMSBroadcastService(userRepository, smsService, smsBroadcastRepository)
	smsBroadcastHandler := admin.NewSMSBroadcastHandler(smsBroadcastService)
	...
	gatewayService := service.NewGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, paymentService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, balanceNotifyService, serviceUserPlatformQuotaRepository)
	...
	settingHandler := handler.ProvideAdminSettingHandler(settingService, emailService, turnstileService, opsService, paymentConfigService, paymentService, promptArchiveService, userAttributeService, notificationEmailService, adminService)
	...
	affiliateHandler := admin.NewAffiliateHandler(affiliateService, affiliateWithdrawalService, adminService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, smsBroadcastHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler)
	usageRecordWorkerPool := service.NewUsageRecordWorkerPool(configConfig)
	userMsgQueueCache := repository.NewUserMsgQueueCache(redisClient)
	userMessageQueueService := service.ProvideUserMessageQueueService(userMsgQueueCache, rpmCache, configConfig)
	gatewayHandler := handler.NewGatewayHandler(gatewayService, geminiMessagesCompatService, antigravityGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, promptArchiveService, userMessageQueueService, configConfig, settingService)
	openAIGatewayHandler := handler.NewOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, promptArchiveService, configConfig)
	handlerSettingHandler := handler.ProvideSettingHandler(settingService, buildInfo, notificationEmailService)
	totpHandler := handler.NewTotpHandler(totpService)
	handlerPaymentHandler := handler.ProvidePaymentHandler(paymentService, paymentConfigService, channelService, gatewayService)
