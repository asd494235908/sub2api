...
func init() {
	...
	subscriptionplanDescPurchaseOncePerActiveSubscription := subscriptionplanFields[11].Descriptor()
	...
	subscriptionplanDescWeeklySaleDays := subscriptionplanFields[12].Descriptor()
	...
	subscriptionplanDescDailyPurchaseLimit := subscriptionplanFields[15].Descriptor()
	...
	subscriptionplanDescDailySaleStartsAt := subscriptionplanFields[16].Descriptor()
	...
	subscriptionplanDescDailySaleEndsAt := subscriptionplanFields[17].Descriptor()
