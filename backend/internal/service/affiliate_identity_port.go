...
type AffiliateIdentityRepository interface {
	...
	GetIdentityCandidate(ctx context.Context, inviteeUserID int64, cfg *AffiliateIdentityConfig) (*AffiliateIdentityCandidate, error)
	HasIdentity(ctx context.Context, userID int64, identityType string) (bool, error)
