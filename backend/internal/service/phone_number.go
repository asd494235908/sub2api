...
// NormalizePhoneNumber converts raw input into a coarse E.164-style number.
// It intentionally keeps the implementation simple for the placeholder SMS phase:
// digits only, optional leading '+', and a caller-provided default country code.
