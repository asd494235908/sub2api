...
func (r *paymentFulfillmentAffiliateRepoStub) AdminSetInviteRelation(context.Context, int64, int64, bool) (*AffiliateInviteRelationChange, error) {
...
func (r *paymentFulfillmentAffiliateRepoStub) AwardSignupBonus(context.Context, int64, int64, float64) (bool, float64, error) {
...
func (r *paymentFulfillmentAffiliateRepoStub) TransferQuotaToBalance(context.Context, int64, float64) (float64, float64, error) {
...
func (r *paymentFulfillmentAffiliateRepoStub) ListInvitersWithInvitees(context.Context, AffiliateAdminFilter) ([]AffiliateInviterEntry, int64, error) {
	panic("unexpected ListInvitersWithInvitees call")
}

func (r *paymentFulfillmentAffiliateRepoStub) ListInviteesByInviter(context.Context, int64, int) ([]AffiliateInvitee, error) {
...
func (r *paymentFulfillmentAffiliateRepoStub) ListUserAffiliateRecords(context.Context, int64, AffiliateRecordFilter) ([]UserAffiliateRecord, int64, error) {
