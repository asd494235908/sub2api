...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		SubscriptionTotalLimitUSD:       g.SubscriptionTotalLimitUSD,
...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	...
	if (rc.Type == "admin_balance" || rc.Type == "admin_concurrency" || rc.Type == service.RedeemTypeFirstRechargeBonus) && rc.Notes != "" {
		out.Notes = &rc.Notes
	}
