...
func (r *stubUsageLogRepo) GetUserTokenLeaderboard(ctx context.Context, startTime, endTime time.Time, limit int, ignoredUserIDs []int64) (*usagestats.UserTokenLeaderboardResponse, error) {
	return nil, errors.New("not implemented")
}
