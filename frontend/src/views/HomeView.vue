...
const footerColumns = computed(() => [
  ...
  },
  {
    ...
    items: [
      ...
      { label: t('home.landing.footer.columns.company.terms'), href: docUrl.value, external: true },
      { label: t('home.landing.footer.columns.company.privacy'), href: docUrl.value, external: true }
    ]
  },
  {
    title: t('home.landing.footer.columns.support.title'),
    items: [
      { label: t('home.landing.footer.columns.support.help'), href: docUrl.value, external: true },
