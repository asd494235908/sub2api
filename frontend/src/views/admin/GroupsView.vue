            ...
            <div class="space-y-1">
              ...
              >
                ...
                >
                  ...
                  >
                  <span
                    v-if="row.monthly_limit_usd && row.subscription_total_limit_usd"
                    class="mx-1 text-gray-300 dark:text-gray-600"
                    >·</span
                  >
                  <span v-if="row.subscription_total_limit_usd" class="whitespace-nowrap"
                    >{{ formatUsd(row.subscription_total_limit_usd) }}/{{
