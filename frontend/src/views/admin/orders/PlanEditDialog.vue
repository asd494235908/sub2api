...
const planForm = reactive({ name: '', group_id: null as number | null, description: '', price: 0, original_price: 0, currency: '', validity_days: 30, validity_unit: 'days', sort_order: 0, for_sale: true, purchase_once_per_active_subscription: false, weekly_sale_days: [] as number[], sale_starts_at: '', sale_ends_at: '', daily_purchase_limit: 0, daily_sale_starts_at: '', daily_sale_ends_at: '' })
...
watch(() => props.show, (visible) => {
  ...
  if (props.plan) {
    ...
    Object.assign(planForm, { name: '', group_id: null, description: '', price: 0, original_price: 0, currency: '', validity_days: 30, validity_unit: 'days', sort_order: 0, for_sale: true, purchase_once_per_active_subscription: false, weekly_sale_days: [], sale_starts_at: '', sale_ends_at: '', daily_purchase_limit: 0, daily_sale_starts_at: '', daily_sale_ends_at: '' })
