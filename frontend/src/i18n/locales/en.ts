  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        qqGroupPlaceholder: 'e.g., 123456789',
        wechatContact: 'Homepage WeChat',
        wechatContactPlaceholder: 'e.g., sub2api_support',
        homepageContactHint: 'Plain-text contacts shown in the homepage footer; leave empty to hide each item.',
        homeLinks: {
