export default {
  ...
  payment: {
    ...
    platformQuotaAmount: '{amount} platform quota',
    firstRecharge: {
      title: 'First Recharge Bonus',
      description: 'Choose a recharge tier to receive platform quota plus a first recharge bonus after payment.',
      tierBonus: 'Bonus {amount} platform quota',
    },
